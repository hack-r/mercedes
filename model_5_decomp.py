...
print("Model 5: linear_model.LassoCV")
...
submission.columns = ['ID', 'pred_5_decomp']
submission.to_csv('T:/RNA/Baltimore/Jason/ad_hoc/mb/insample/model_5_decomp_pred_insample.csv', index=False)

submission.y       = prediction1
submission.columns = ['ID', 'pred_5_decomp']
submission.to_csv('T:/RNA/Baltimore/Jason/ad_hoc/mb/layer1_test/model_5_decomp_pred_layer1_test.csv', index=False)
