...
try:
    for z in np.arange(.0035, .006, .00025):
        for j in np.arange(.92, .96, .002):
            ...
            # ICA
            ica = FastICA(n_components=n_ica, random_state=42,max_iter=1000, tol=.0008)
