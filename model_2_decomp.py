...
print("Model 2: linear_model.ElasticNetCV")
...
submission.columns = ['ID', 'pred_2_decomp']
submission.to_csv('T:/RNA/Baltimore/Jason/ad_hoc/mb/insample/model_2_decomp_pred_insample.csv', index=False)

submission.y       = prediction1
submission.columns = ['ID', 'pred_2_decomp']
submission.to_csv('T:/RNA/Baltimore/Jason/ad_hoc/mb/layer1_test/model_2_decomp_pred_layer1_test.csv', index=False)
