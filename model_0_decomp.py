...
print("Model 0: linear_model.BayesianRidge")
...
if oof_score > .4 and score > .4:
    ...
    submission.columns = ['ID', 'pred_0_decomp']
    submission.to_csv('T:/RNA/Baltimore/Jason/ad_hoc/mb/insample/model_0_decomp_pred_insample.csv', index=False)

    submission.y       = prediction1
    submission.columns = ['ID', 'pred_0_decomp']
    submission.to_csv('T:/RNA/Baltimore/Jason/ad_hoc/mb/layer1_test/model_0_decomp_pred_layer1_test.csv', index=False)
