...
print("Model 16: linear_model.RandomizedLasso")
...
submission.to_csv('T:/RNA/Baltimore/Jason/ad_hoc/mb/insample/model_16_decomp_pred_insample.csv', index=False)

submission.y = prediction1
submission.to_csv('T:/RNA/Baltimore/Jason/ad_hoc/mb/layer1_test/model_16_decomp_pred_layer1_test.csv', index=False)
