...
print("Model 21: linear_model.SGDRegressor")
...
submission.to_csv('T:/RNA/Baltimore/Jason/ad_hoc/mb/insample/model_21_decomp_pred_insample.csv', index=False)

submission.y = prediction1
submission.to_csv('T:/RNA/Baltimore/Jason/ad_hoc/mb/layer1_test/model_21_decomp_pred_layer1_test.csv', index=False)
