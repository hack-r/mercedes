...
print("Model 19: linear_model.Ridge")
...
submission.to_csv('T:/RNA/Baltimore/Jason/ad_hoc/mb/insample/model_19_decomp_pred_insample.csv', index=False)

submission.y = prediction1
submission.to_csv('T:/RNA/Baltimore/Jason/ad_hoc/mb/layer1_test/model_19_decomp_pred_layer1_test.csv', index=False)
