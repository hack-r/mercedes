...
print("Model 4: linear_model.Lasso")
...
submission.columns = ['ID', 'pred_4_decomp']
submission.to_csv('T:/RNA/Baltimore/Jason/ad_hoc/mb/insample/model_4_decomp_pred_insample.csv', index=False)

submission.y       = prediction1
submission.columns = ['ID', 'pred_4_decomp']
submission.to_csv('T:/RNA/Baltimore/Jason/ad_hoc/mb/layer1_test/model_4_decomp_pred_layer1_test.csv', index=False)
