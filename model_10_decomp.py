...
print("Model 10: linear_model.OrthogonalMatchingPursuit")
...
submission.columns = ['ID', 'pred_10_decomp']
submission.to_csv('T:/RNA/Baltimore/Jason/ad_hoc/mb/insample/model_10_decomp_pred_insample.csv', index=False)

submission.y       = prediction1
submission.columns = ['ID', 'pred_10_decomp']
submission.to_csv('T:/RNA/Baltimore/Jason/ad_hoc/mb/layer1_test/model_10_decomp_pred_layer1_test.csv', index=False)
