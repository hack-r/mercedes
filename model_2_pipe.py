...
try:
    for z in range(1, 14, 1):  # np.arange(.0035, .006, .00025): #(0,1,1):#
        for j in range(1, 14, 1):  # np.arange(.92, .96, .002):#(0,1,1):#(
            print(z)
            print(j)
...
sub.to_csv('T://RNA//Baltimore//Jason//ad_hoc//mb//output//jdm_stacked_models3_z9_j7.csv', index=False)
...
8    9.0  13.0  0.461464
9   11.0   1.0  0.462064
10  11.0   7.0  0.467091
11  11.0  13.0  0.467654
12  13.0   1.0  0.470229
'''
