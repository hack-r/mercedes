...
print("Model 26: linear_model.logistic_regression_path")
...
for fold, (train_index, test_index) in enumerate(kf.split(X)):
    ...
    clf = linear_model.logistic_regression_path()
...
submission.to_csv('T:/RNA/Baltimore/Jason/ad_hoc/mb/insample/model_26_decomp_pred_insample.csv', index=False)

submission.y = prediction1
submission.to_csv('T:/RNA/Baltimore/Jason/ad_hoc/mb/layer1_test/model_26_decomp_pred_layer1_test.csv', index=False)
