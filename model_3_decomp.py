...
print("Model 3: linear_model.ElasticNetCV")
...
for fold, (train_index, test_index) in enumerate(kf.split(X)):
    ...
    clf = linear_model.ElasticNetCV(l1_ratio=0.5, eps=0.001, n_alphas=100, alphas=None, fit_intercept=True, normalize=False, precompute='auto', max_iter=1000, tol=0.0001, cv=None, copy_X=True, verbose=0, n_jobs=1, positive=False, random_state=None, selection='cyclic')
...
submission.to_csv('T:/RNA/Baltimore/Jason/ad_hoc/mb/insample/model_3_decomp_pred_insample.csv', index=False)

submission.y = prediction1
submission.to_csv('T:/RNA/Baltimore/Jason/ad_hoc/mb/layer1_test/model_3_decomp_pred_layer1_test.csv', index=False)
