...
print("Model 1: KRR with base features + latent variables, etc")
...
submission.columns = ['ID', 'pred_model_1_krr_decomp']
submission.to_csv('T:/RNA/Baltimore/Jason/ad_hoc/mb/insample/model_1_krr_pred_insample.csv', index=False)

submission.y       = prediction1
submission.columns = ['ID', 'pred_model_1_krr_decomp']
submission.to_csv('T:/RNA/Baltimore/Jason/ad_hoc/mb/layer1_test/model_1_krr_pred_layer1_test.csv',index=False)

print("Done.")

"""""
=====================
Final Score 0.599514
Final Out-of-Fold Score 0.499868
=====================
"""""